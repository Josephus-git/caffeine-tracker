...
export default function CoffeeForm(props: coffeeFormProps) {
    ...
    const [selectedCoffee, setSelectedCoffee] = useState<null|string>(null)
    ...
    async function handleSubmitForm() {
        ...
        const userRef = doc(db, 'users', String(globalUser?.uid))
    ...
    return (
        ...
        {showModal && (
            ...
            <input className="w-full" type="number" value={coffeeCost} onChange={(e) => {
                setCoffeeCost(Number(e.target.value)) // check !!!!!!!----
            }} placeholder="4.50" />
